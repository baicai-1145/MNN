...
"#ifdef APPLY_ROTARY\n"
"#define APPLY_ROTARY_TO_TEMP(seq_sl) "" {"" const int cb = cos_batch == 1 ? 0 : b;"" const int rot_offset = ((((seq_sl) * cos_batch + cb) * (head_dim / 2) + 2 * hd) * 4);"" FLOAT4 cos_0 = vload4(0, cos + rot_offset);"" FLOAT4 sin_0 = vload4(0, sin + rot_offset);"" FLOAT4 cos_1 = vload4(0, cos + rot_offset + 4);"" FLOAT4 sin_1 = vload4(0, sin + rot_offset + 4);"" FLOAT4 even_0 = temp_0;"" FLOAT4 odd_0 = temp_1;"" FLOAT4 even_1 = temp_2;"" FLOAT4 odd_1 = temp_3;"" temp_0 = even_0 * cos_0 - odd_0 * sin_0;"" temp_1 = odd_0 * cos_0 + even_0 * sin_0;"" temp_2 = even_1 * cos_1 - odd_1 * sin_1;"" temp_3 = odd_1 * cos_1 + even_1 * sin_1;"" }\n"
"#else\n"
